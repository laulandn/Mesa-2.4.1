...
/**
 ...
 GLUT_MACMESA_IMPLEMENTATION is updated to reflect both GLUT
 API revisions and implementation revisions (ie, bug fixes).

 GLUT_MACMESA_IMPLEMENTATION=1  first implemenatation, based on
  								GLUT_XLIB_IMPLEMENTATION=8 
**/
...
**/
#ifndef GLUT_MACMESA_IMPLEMENTATION  /* Allow this to be overriden. */
#define GLUT_MACMESA_IMPLEMENTATION	1
#endif
