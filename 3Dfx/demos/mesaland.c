...
static void reshape( int width, int height )
{
  ...
  glLoadIdentity();
  gluPerspective(50.0, ((GLfloat) width/(GLfloat)height), 1, lenghtXmnt*stepYmnt*0.7);
...
void drawscene(void)
{
  ...
  printstring(GLUT_BITMAP_HELVETICA_10,"Terrain V1.1 Written by David Bucciarelli (tech.hmw@plus.it)");
