...
static void draw(void)
{
  ...
  printstring(GLUT_BITMAP_HELVETICA_10,"Tunnel V1.1 Written by David Bucciarelli (tech.hmw@plus.it)");
...
static void inittextures(void)
{
  ...
  /*glTexImage2D(GL_TEXTURE_2D,0, 3, img->sizeX, img->sizeY,0, GL_RGB,GL_UNSIGNED_BYTE, (GLvoid *)(img->data));*/
...
int main(int ac, char **av)
{
  ...
  glMatrixMode(GL_PROJECTION);
  glLoadIdentity();
  gluPerspective(80.0,640/(float)480,1.0,50.0);
