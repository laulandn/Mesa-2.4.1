...
/*
PPro@200MHz+WinNT+Obsidian (2 boards => 90 MPixels/sec):
...
static void drawfire(void)
{
  ...
  printstring(GLUT_BITMAP_HELVETICA_10,"Fire V1.4 Written by David Bucciarelli (tech.hmw@plus.it)");
...
int main(int ac,char **av)
{
  ...
  if (glutCreateWindow("Fire") == GL_FALSE) {
