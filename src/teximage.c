/* $Id: teximage.c,v 1.24 1997/09/03 13:17:17 brianp Exp $ */
...
gl_image_to_texture( GLcontext *ctx, const struct gl_image *image,
                     GLenum internalFormat, GLint border )
{
   ...
   switch (image->Type) {
               ...
               for (i=0; i<image->Width; i++) {
                  ...
                  switch (internalFormat) {
                     ...
                     case GL_RGBA:
                        ...
                        break;
                     default:
                        gl_problem(ctx,"Bad format in gl_image_to_texture");
                        return NULL;
                  }
               }
               if (bitMask!=128) {
         ...
         for (pixel=0; pixel<numPixels; pixel++) {
            ...
            switch (image->Format) {
              ...
              case GL_LUMINANCE_ALPHA:
                  ...
                  break;
              default:
                 gl_problem(ctx,"Bad format (2) in gl_image_to_texture");
                 return NULL;
            }
            ...
            switch (internalFormat) {
               ...
               case GL_RGBA:
                  ...
                  break;
               default:
                  gl_problem(ctx,"Bad format (3) in gl_image_to_texture");
                  return NULL;
            }
         }
         break;
         ...
         for (pixel=0; pixel<numPixels; pixel++) {
            ...
            switch (image->Format) {
              ...
              case GL_LUMINANCE_ALPHA:
                  ...
                  break;
               default:
                  gl_problem(ctx,"Bad format (4) in gl_image_to_texture");
                  return NULL;
            }
            ...
            switch (internalFormat) {
               ...
               case GL_RGBA:
                  ...
                  break;
               default:
                  gl_problem(ctx,"Bad format (5) in gl_image_to_texture");
                  return NULL;
            }
         }
         break;
      ...
      default:
         gl_problem(ctx, "Bad image type in gl_image_to_texture");
         return NULL;
   }
                       ...
                       struct gl_image *image )
{
   ...
   if (image) {
      ...
      if (texcomponents == image->Components) {
         ...
         GLubyte *dst = teximage->Data + texcomponents * xoffset;
